...
\copy hralit_triple from data/ontology/hralit_ontology_triple.csv Delimiter E',' CSV HEADER Encoding 'SQL-ASCII';
...
\copy hralit_digital_objects from data/experimental/hra_do_5th_release.csv Delimiter E',' CSV HEADER Encoding 'SQL-ASCII';
