...
with cellxgene_census.open_soma() as census:
    ...
    cell_metadata.to_csv('cxg_datasets.csv')
    ...
    cell_metadata.to_csv('cxg_summary.csv')
    ...
    cell_metadata.to_csv('cxg_cell_metadata.csv')
    ...
    cell_metadata.to_csv('cxg_gene_metadata.csv')
