...
# Load the datasets
gtex_donor = pd.read_csv("HRALit_KG\\donors\\gtex_donor.csv")
hubmap_donor = pd.read_csv("HRALit_KG\\donors\\hubmap_donor.csv")
cxg_donor = pd.read_csv("HRALit_KG\\donors\\cxg_donor.csv")
...
harmonized_donor_expanded.to_csv('harmonized_donor.csv')
